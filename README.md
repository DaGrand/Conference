...
Passionné par les technologies de l'information depuis plus de **20 ans**, j'ai développé une solide expertise en **cybersécurité** et en **gestion d'environnements informatiques complexes**.

Mon parcours m'a mené autant vers l'**entrepreneuriat** que vers l'**enseignement**, notamment lorsque j'ai fondé et dirigé ma propre entreprise technologique, qui a compté plus de **25 employés**.

Aujourd'hui, je contribue au renforcement de la **résilience des infrastructures critiques** et j'aime transmettre mon expérience lors de conférences.
...
*« Renforcer la résilience des infrastructures critiques, une conférence à la fois. »*
